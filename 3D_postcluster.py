...
for i in range(3):
	...
	ax[0][1].imshow(numpy.sum(reconstr, axis=0), cmap="gray" )
	ax[0][1].set_title("Reconstruction")
	ax[0][0].imshow(numpy.sum(noisy, axis=0), cmap="gray" )
	ax[0][0].set_title("Noisy")
	ax[1][1].imshow(numpy.sum(reconstr, axis=1), cmap="gray" )
	ax[1][1].set_title("Reconstruction")
	ax[1][0].imshow(numpy.sum(noisy, axis=1), cmap="gray" )
	ax[1][0].set_title("Noisy")
	ax[2][1].imshow(numpy.sum(reconstr, axis=2), cmap="gray" )
	ax[2][1].set_title("Reconstruction")
	ax[2][0].imshow(numpy.sum(noisy, axis=2), cmap="gray" )
	ax[2][0].set_title("Noisy")
