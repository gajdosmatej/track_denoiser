...
ARCHITECTURES = [
	{	"name":	"stonozka_no_pooling_2",
		"mode":	"classification",
		"epochs": 200,
		"model": keras.Sequential([	keras.layers.Input(shape=(12,14,208,1)),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(3,3,8), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,2), kernel_size=(3,3,3), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(2,2,8), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,2), kernel_size=(3,3,3), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(2,2,8), filters=6, activation="relu"),
										...
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(2,2,8), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(3,3,3), filters=6, activation="relu"),
										keras.layers.UpSampling3D(size=(1,1,2)),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(2,2,8), filters=6, activation="relu"),
										keras.layers.Conv3D(padding="same", strides=(1,1,1), kernel_size=(3,3,3), filters=6, activation="relu"),
										keras.layers.UpSampling3D(size=(1,1,2)),
